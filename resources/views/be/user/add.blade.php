            ...
            <div class="card card-primary">
                ...
                <form method="post" action="{{ route('admin.user.doAdd') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chọn
                                Quyền</label>
                    ...
                    <div class="card-footer">
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Thêm mới</button>
                    </div>
                </form>
            </div>
        </div>
