            ...
            <div class="row">
                <div class="col-12">
                    <div class="callout callout-info">
                        Chi tiết đơn hàng
                        <a href="{{ route('be.order.list') }}" class=" float-right">Quay lại</a>
                    </div>
                </div>
                ...
                <div class="invoice p-3 m-auto" style="width:90%">
                    ...
                    <div class="card-footer clearfix">
                        ...
                        <div class="float-right">
                            @if ($order->status == 1)
                                <a type="button"
                                    href="{{ route('be.order.changeStatus', ['id' => $order->id, 'status' => 2]) }}"
                            ...
                            @if ($order->status == 2)
                                <a type="button"
                                    ...
                                    href="{{ route('be.order.changeStatus', ['id' => $order->id, 'status' => 3]) }}">
                                    Success
                                </a>
                            @endif
                            ...
                            <a type="button"
                                ...
                                href="{{ route('be.order.changeStatus', ['id' => $order->id, 'status' => 4]) }}">
                                Cancel
                            </a>
