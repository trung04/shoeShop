...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <form method="post" action="{{ route('admin.voucher.doEdit', $voucher->id) }}">
            @csrf
            <div class="card-body">
                <div>
                    <label>Type</label>
                ...
                <div class="form-group">
                    <label>Coin</label>
                    <input type="number" value="{{ $voucher->coin }}" name="coin" class="form-control"
                        placeholder="Enter Voucher's Coin">
                </div>
            </div>
